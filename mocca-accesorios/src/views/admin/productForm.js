...
export function openProductForm(modalRoot, { producto, categorias, onSaved }) {
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            <div class="form-field">
              ...
              <input type="number" id="pf-precio" min="0" step="500" inputmode="numeric" value="${producto?.precio ?? ''}" placeholder="0" />
            </div>
            <div class="form-field">
  ...
  modalRoot.querySelector('#pf-save').addEventListener('click', async () => {
    ...
    const precio = Number(modalRoot.querySelector('#pf-precio').value);
