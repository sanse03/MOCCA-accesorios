  ...
  container.innerHTML = `
    <div class="catalogo-screen">
      <div class="brand-hero">
        <p class="brand-hero-label">Accesorios</p>
        <h1 class="brand-hero-title">MOCCA</h1>
      </div>
      <header class="catalogo-header">
        <div class="catalogo-title-row">
          <h2 class="catalogo-title">Catálogo</h2>
          ${isAdmin ? '<button type="button" class="text-link" id="manage-categories-btn">Categorías</button>' : ''}
        </div>
